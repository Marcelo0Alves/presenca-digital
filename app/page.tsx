  ...
  return (
    <main className="flex flex-col min-h-screen bg-white" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <nav className="flex items-center justify-between px-8 py-5 border-b border-gray-100 sticky top-0 bg-white/95 backdrop-blur-sm z-50">
        ...
        <Link href="/criar" className="bg-gray-900 text-white px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-gray-700 transition-colors">
          Começar grátis
        </Link>
      </nav>
      ...
      <section className="px-8 pt-20 pb-24 md:pt-28 md:pb-32">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          {/* Esquerda */}
          <div>
            <div className="inline-flex items-center gap-2 border border-gray-200 text-gray-500 text-xs font-medium px-4 py-1.5 rounded-full mb-8">
            ...
            <p className="text-gray-500 text-lg leading-relaxed mb-4">
              Agência cobra R$ 3.000 pra criar uma página e R$ 1.500/mês pra fazer anúncios — e você ainda fica dependente deles pra qualquer mudança.
            </p>
            <p className="text-gray-500 text-lg leading-relaxed mb-10">
              Com o Presença Digital você descreve o que faz em uma frase e em 5 minutos tem tudo pronto. <strong className="text-gray-800">Sem precisar entender de tecnologia.</strong>
            </p>
            <div className="flex flex-col sm:flex-row gap-3">
              <Link href="/criar"
                className="inline-flex items-center justify-center gap-2.5 bg-indigo-600 text-white px-8 py-4 rounded-full font-bold text-base hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-100 hover:scale-[1.02]">
                Criar minha presença agora
                <ArrowRight size={18} />
              </Link>
            </div>
            <p className="mt-4 text-sm text-gray-400">3 dias grátis. Cancele quando quiser.</p>
          </div>

          {/* Direita — comparativo */}
          <div className="flex flex-col gap-3">
            {[
              { desc: "Página profissional", antes: "Agência", precoAntes: "R$ 3.000", precoDepois: "R$ 127/mês" },
              { desc: "Anúncios para Meta Ads", antes: "Redator", precoAntes: "R$ 800/mês", precoDepois: "Incluso" },
              { desc: "Pixel do Meta configurado", antes: "Dev / agência", precoAntes: "R$ 500", precoDepois: "Incluso" },
              { desc: "Bio do Instagram otimizada", antes: "Designer", precoAntes: "R$ 300", precoDepois: "Incluso" },
            ].map((item) => (
              <div key={item.desc} className="bg-gray-50 rounded-2xl p-5 flex items-center justify-between gap-4 border border-gray-100">
                ...
                <span className={`text-xs font-bold px-3 py-1.5 rounded-full flex-shrink-0 ${item.precoDepois === "Incluso" ? "bg-emerald-50 text-emerald-700" : "bg-indigo-50 text-indigo-700"}`}>
                  {item.precoDepois}
                </span>
              </div>
            ))}
            <div className="bg-indigo-600 rounded-2xl p-5 flex items-center justify-between mt-1">
              <div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { n: "02", title: "Sua página é criada", desc: "Página completa, anúncios e bio do Instagram — prontos automaticamente." },
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg max-w-xl mx-auto">
              O que custaria uma fortuna com agência — entregue de forma simples.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: <Zap size={22} className="text-indigo-600" />, bg: "bg-indigo-50", title: "Página profissional", desc: "Design elegante e moderno, com cores e textos pensados para o seu tipo de negócio." },
              { icon: <TrendingUp size={22} className="text-emerald-600" />, bg: "bg-emerald-50", title: "3 anúncios prontos", desc: "Textos prontos para converter no Meta Ads. Copie, cole e comece a anunciar." },
              { icon: <Shield size={22} className="text-purple-600" />, bg: "bg-purple-50", title: "Pixel do Meta", desc: "Rastreamento configurado automaticamente. Cada visita alimenta o algoritmo por você." },
            ].map((item) => (
              <div key={item.title} className="rounded-2xl p-8 border border-gray-100 bg-white shadow-sm">
                <div className={`w-11 h-11 ${item.bg} rounded-xl flex items-center justify-center mb-5`}>{item.icon}</div>
      ...
      <section className="px-8 py-24 bg-gray-900">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-xl">Os 3 textos gerados já estão prontos para o Meta Ads. Copie, cole e comece a atrair clientes hoje.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-4">
            {[
              { n: "01", title: "Copie o texto", desc: "Escolha uma das 3 versões prontas — cada uma com um foco diferente para públicos distintos." },
          ...
          <p className="mt-10 text-center text-gray-500 text-sm">Com R$ 10–20/dia em anúncios você já começa a receber contatos no primeiro dia.</p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              <div key={ex.nome} className="bg-white border border-gray-100 rounded-2xl p-6 flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                <div className="w-12 h-12 rounded-xl flex-shrink-0 flex items-center justify-center text-white font-bold text-xl" style={{ backgroundColor: ex.cor }}>
                  {ex.nome.charAt(0)}
                </div>
                <div>
      ...
      <section className="px-8 py-24">
        <div className="max-w-md mx-auto text-center">
          ...
          <div className="bg-white border border-gray-100 rounded-3xl p-8 shadow-xl">
            ...
            <Link href="/criar" className="flex items-center justify-center gap-2 w-full bg-indigo-600 text-white py-4 rounded-full font-bold text-base hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-100">
